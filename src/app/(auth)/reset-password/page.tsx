      ...
      <div className="w-full">
        ...
        <div className={`relative ${passwordError ? "rounded-[10px] ring-1 ring-red-500" : ""}`}>
          ...
          <input
            ...
            disabled={loading}
            className="h-[50px] w-full rounded-full border border-border bg-card shadow-sm px-14 pr-14 text-[16px] text-black outline-none transition placeholder:text-[#aaa] focus:border-primary focus:ring-1 focus:ring-primary disabled:cursor-not-allowed disabled:bg-gray-50"
          />
          <button
            type="button"
      ...
      <div className="w-full">
        ...
        <div className="relative">
          ...
          <input
            ...
            disabled={loading}
            className="h-[50px] w-full rounded-full border border-border bg-card shadow-sm px-14 text-[16px] text-black outline-none transition placeholder:text-[#aaa] focus:border-primary focus:ring-1 focus:ring-primary disabled:cursor-not-allowed disabled:bg-gray-50"
          />
        </div>
      </div>
