...
export function InvoiceTemplatesPanel({ templates, organization }: { templates: InvoiceTemplate[]; organization: Organization }) {
  ...
  async function handleSelect(templateId: string) {
    ...
    try {
      const res = await fetch("/api/organizations", {
        ...
        body: JSON.stringify({ uid: organization.uid, invoice_template_id: templateId }),
      });
      if (!res.ok) {
