...
import type { ActivityPayment } from "@/lib/activities";
...
// The "Add New Payment" popup on the Activity Detail page's Payments tab —
// records a payout the agency makes OUT to this activity vendor for one of
// its actual bookings. Mirrors HotelPaymentModal.tsx exactly.
export function ActivityPaymentModal({
  open,
  activityUid,
  escapeOptions,
  onClose,
  ...
  onClose: () => void;
  onSaved: (payment: ActivityPayment) => void;
}) {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    setSaving(true);
    try {
      const res = await clientApi.post<ActivityPayment>(`/library/activities/${activityUid}/payments`, {
